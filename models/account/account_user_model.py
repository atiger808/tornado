...
class User(Base):
    ...
    # files = relationship('Files', backref='user') #一对多关系表

    # 从用户找文件
    users_files = relationship('Files', secondary=FilesToUser.__table__, lazy='dynamic')# lazy惰性查询文件
