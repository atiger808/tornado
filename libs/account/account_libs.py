...
def send_email_libs(self, email):
    ...
    content = """
        <p> html 邮件格式练习</p>
        <p><a href="http://www.shuaibin.wang:8888/account/auth_email_code?code={}&email={}&user_id={}">邮箱绑定链接</a></p>
    """.format(email_code, email, u)

    send_fail = send_qq_html_email("594542251@qq.com", [email], '发送邮件验证', content)
    if send_fail:
...
def add_avatar_lib(self, avatar_data):
    ...
    try:
        ...
        send_qq_html_email(
            "594542251@qq.com",
            ["1197773452@qq.com", "594542251@qq.com"],
            "第六课邮箱验证测试",
